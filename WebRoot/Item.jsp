...
<script type="text/javascript">
	...
	$(document).ready(function() {
	    initTree('','');
	    initTree2();
	    document.getElementById("FrmWorkSpace").style.height = document.documentElement.clientHeight-10 + "px";
	    document.getElementById("typeTree").style.height = document.documentElement.clientHeight-220 + "px";
	});
	...
	<table style="width: 100%; height: 100%;" align="center"
		...
		<tr>
			<td style="vertical-align:top; text-align: left; width: 300px;">
				        		...
				        		<tr>
				        			<td>
										...
										<input class="BorderTextInput" id="name" style="width: 100px"/>
											<img src="images/pageFrame/1070.png" width='17' height='17'/>[<a onclick="return addName();" style="cursor: pointer;">新增</a>]
											<img src="images/pageFrame/1083.png" width='17' height='17'/>[<a onclick="deleteTreeids();" style="cursor: pointer;">删除</a>]
									</td>
				        		</tr>
				        		<tr>
				        			<td colspan="2">
									    ...
									    <img src="images/pageFrame/1060.png" width='17' height='17'/>[<a onclick="return ajaxFileUpload();" style="cursor: pointer;">上传</a>]
				        			</td>
				        		</tr>
				        	</table>
					      </td>
				...
				<hr/>
				<div style="height:100px; width:300px;overflow:auto;" id="TemplateTree"></div>
			</td>

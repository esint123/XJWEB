...
<script type="text/javascript">
	function uploadFile(attache_id, attache_field, attache_fileid) {
		var url = "ItemLibrary/AttachFile.jsp?tableName=TItemlibraryNew10&attache_id=" + attache_id
	...
	$(document).ready(function() {
		InitData();
		//$("#mydiv").height = document.documentElement.clientHeight-34 + "px";
	});
	//单个删除
	...
	function InitData() {
	    ...
	    if(stage=='')
	    {
	    	url="New10Json.action?treeid="+getQueryString("treeid");
	    }
	    else
	    {
	    	url="New10Json.action?treeid="+getQueryString("treeid")+"&stage="+stage;
	    }
		$.getJSON(url,
						function(data) {
	...
	<div id=mydiv style="display:block;">
		<table id="productTable" width="5600px" border="0" cellpadding="0"
			...
			<tr>
				...
				<th class="tdDropTitle" rowspan="3" width="60px"><a
					style="cursor: pointer;"> <font>工程属性</font> </a>
				</th>
				<th class="tdDropTitle" rowspan="3" width="60px"><a
			...
			<tr>
				...
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font>供电半径(千米)</font>
				</a>
				</th>
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font>无功补偿容量(千乏)</font>
				</a>
				</th>
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font>中压线路投资(万元)</font>
				</a>
				</th>
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font>开闭所(座)</font> </a>
				</th>
				<th class="tdDropTitle" width="60px"><a
					style="cursor: pointer;"> <font>环网柜</font> </a>
				</th>
				<th class="tdDropTitle" width="60px"><a
					style="cursor: pointer;"> <font>环网柜</font> </a>
				</th>
				...
				<th class="tdDropTitle" width="60px"><a
					style="cursor: pointer;"> <font>柱上开关</font> </a>
				</th>
				...
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font>电缆分支箱(座)</font>
				</a>
				</th>
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font>中压开关投资(万元)</font>
				</a>
				</th>
				<th class="tdDropTitle" colspan="3" width="60px"><a
					style="cursor: pointer;"> <font>配电室</font> </a>
				</th>
				<th class="tdDropTitle" width="60px"><a
					style="cursor: pointer;"> <font>箱变</font> </a>
				</th>
				<th class="tdDropTitle" width="60px"><a
					style="cursor: pointer;"> <font>箱变</font> </a>
				</th>
				...
				<th class="tdDropTitle" width="60px"><a
					style="cursor: pointer;"> <font>柱上变</font> </a>
				</th>
				<th class="tdDropTitle" width="60px"><a
					style="cursor: pointer;"> <font>柱上变</font> </a>
				</th>
				<th class="tdDropTitle" width="60px"><a
					style="cursor: pointer;"> <font>其中：非晶合金配变</font>
				</a>
				</th>
				<th class="tdDropTitle" width="60px"><a
					style="cursor: pointer;"> <font>其中：非晶合金配变</font>
				...
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font>中压配变投资(万元)</font>
				</a>
				</th>
				<th class="tdDropTitle" colspan="3" width="60px"><a
					style="cursor: pointer;"> <font>架空线路</font> </a>
				</th>
				<th class="tdDropTitle" colspan="3" width="60px"><a
					style="cursor: pointer;"> <font>电缆</font> </a>
				</th>
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font>户表(户)</font> </a>
				</th>
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font>接户线(千米)</font>
				</a></th>
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font>户表投资(万元)</font>
				</a>
				</th>
				<th class="tdDropTitle" colspan="2" width="60px"><a
			...
			<tr>
				<th class="tdDropTitle" width="60px"><a
					style="cursor: pointer;"> <font>总数(座)</font> </a>
				</th>
				<th class="tdDropTitle" width="60px"><a
					style="cursor: pointer;"> <font>其中：分段环网柜(座)</font>
				</a>
				</th>
				<th class="tdDropTitle" width="60px"><a
					style="cursor: pointer;"> <font>联络环网柜(座)</font>
				</a>
				</th>
				<th class="tdDropTitle" width="60px"><a
					style="cursor: pointer;"> <font>总数(台)</font> </a>
				</th>
				<th class="tdDropTitle" width="60px"><a
					style="cursor: pointer;"> <font>其中：分段开关(台)</font>
				</a>
				</th>
				<th class="tdDropTitle" width="60px"><a
					style="cursor: pointer;"> <font>联络开关(台)</font>
				</a>
				</th>
				<th class="tdDropTitle" width="60px"><a
					style="cursor: pointer;"> <font>座数(座)</font> </a>
				</th>
				<th class="tdDropTitle" width="60px"><a
					style="cursor: pointer;"> <font>配变台数(台)</font>
				</a>
				</th>
				<th class="tdDropTitle" width="60px"><a
					style="cursor: pointer;"> <font>配变容量(千伏安)</font>
				</a>
				</th>
				<th class="tdDropTitle" width="60px"><a
					style="cursor: pointer;"> <font>座数(座)</font> </a>
				...
				<th class="tdDropTitle" width="60px"><a
					style="cursor: pointer;"> <font>条数(条)</font> </a>
				</th>
				<th class="tdDropTitle" width="60px"><a

...
<html>
  <head>
    <base href="<%=basePath%>">
    <title>10(20、6)kV电网改造工程表(编辑)</title>
  ...
  <body>
  	<s:form id="form1" name="form1" action="SaveRemake10">
		...
		<table id="productTable" width="4600px" border="0" cellpadding="0"
				...
				<th class="tdDropTitle" colspan="8" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">配变</font> </a>
				</th>
				<th class="tdDropTitle" colspan="3"><a style="cursor: pointer;">
						<font color="#1D6597">无功补偿装置</font> </a>
				</th>
				<th class="tdDropTitle" colspan="5"><a
					style="cursor: pointer;"> <font color="#1D6597">开关类</font> </a>
				</th>
				<th class="tdDropTitle" colspan="3"><a style="cursor: pointer;">
						<font color="#1D6597">架空线路</font> </a>
				</th>
				<th class="tdDropTitle" colspan="3"><a style="cursor: pointer;">
						<font color="#1D6597">电缆线路</font> </a>
				</th>
				<th class="tdDropTitle" colspan="6" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">低压网配套</font>
				</a></th>
				<th class="tdDropTitle" colspan="3"><a style="cursor: pointer;">
						<font color="#1D6597">户表</font> </a>
				</th>
				<th class="tdDropTitle" rowspan="3" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">其他投资(万元)</font>
				</a></th>
				<th class="tdDropTitle" rowspan="3" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">总投资(万元)</font> </a>
				</th>
				<th class="tdDropTitle" colspan="7" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">资金来源</font> </a>
				</th>
				<th class="tdDropTitle" rowspan="3" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">改造时间(年)</font>
				</a></th>
				<th class="tdDropTitle" rowspan="3" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">工程属性</font>
				</a></th>
				<th class="tdDropTitle" rowspan="3" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">是否农网</font>
				</a></th>
				<th class="tdDropTitle" rowspan="3" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">农网建设性质1</font> </a>
				</th>
				<th class="tdDropTitle" rowspan="3" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">农网建设性质2</font> </a>
				</th>
				<th class="tdDropTitle" rowspan="3" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">农网建设性质3</font> </a>
				</th>
				<th class="tdDropTitle" rowspan="3" width="60px"><a
			...
			<tr>
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">改造总台数(台)</font>
				</a>
				</th>
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">改造前总容量(千伏安)</font>
				</a>
				</th>
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">改造后总容量(千伏安)</font>
				</a>
				</th>
				<th class="tdDropTitle" rowspan="1" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">其中：需改造高损配变</font>
				</a>
				</th>
				<th class="tdDropTitle" rowspan="1" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">其中：需改造高损配变</font>
				...
				<th class="tdDropTitle" rowspan="1" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">其中：更换为非晶合金配变</font> </a>
				</th>
				<th class="tdDropTitle" rowspan="1" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">其中：更换为非晶合金配变</font> </a>
				</th>
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">配变投资(万元)</font> </a>
				</th>
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">组数(组)</font> </a>
				</th>
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">总容量(千乏)</font> </a>
				</th>

				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">无功补偿装置投资(万元)</font> </a>
				</th>

				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">断路器(台)</font> </a>
				</th>
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">负荷开关(台)</font>
				</a>
				</th>
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">环网柜(座)</font>
				</a>
				</th>
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">电缆分支箱(座)</font> </a>
				</th>
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">开关类投资(万元)</font> </a>
				</th>
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">线路长度(千米)</font> </a>
				</th>
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">其中绝缘导线(千米)</font> </a>
				</th>
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">架空线路投资(万元)</font> </a>
				</th>
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">长度(千米)</font> </a>
				</th>
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">沟道(千米)</font>
				</a>
				</th>
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">电缆线路投资(万元)</font>
				</a>
				</th>
				<th class="tdDropTitle" colspan="3" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">架空线路</font>
				</a>
				</th>
				<th class="tdDropTitle" colspan="3" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">电缆</font>
				</a>
				</th>
				<th class="tdDropTitle" rowspan="2" width="60px"><a
				...
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">接户线(千米)</font> </a>
				</th>
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">户表投资(万元)</font> </a>
				</th>
				...
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">其他(%)</font>
				</a></th>
				<th class="tdDropTitle" rowspan="2" width="60px"><a
	...
	<tr>
				...
				<th class="tdDropTitle" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">总容量(千伏安)</font>
				</a>
				</th>
				<th class="tdDropTitle" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">台数(台)</font>
				</a>
				</th>
				<th class="tdDropTitle" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">总容量(千伏安)</font> </a>
				</th>
				<th class="tdDropTitle" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">条数(条)</font>
				</a>
				</th>
				<th class="tdDropTitle" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">长度(千米)</font>
				</a>
				</th>
				<th class="tdDropTitle" width="60px"><a
				...
				<th class="tdDropTitle" width="60px"><a
				   ...
				   <td>
				   	 <s:textfield name ="item.FE" theme="simple" size="50" cssClass="BorderTextInput"></s:textfield>
				   </td>
				   <td>
	...
	<tr>
					...
					<s:hidden  name ="item.FBj"></s:hidden>
					<s:hidden  name ="item.FBk"></s:hidden>
					<s:hidden  name ="item.FBl"></s:hidden>

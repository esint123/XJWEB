...
<html>
  ...
  <body>
	<s:form id="form1" name="form1" action="SaveRemake35">
		<div id=mydiv style="display:block; overflow-y: hidden ;">
			...
			<tr>
				...
				<th class="tdDropTitle" rowspan="3" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">架空线长度(千米)</font> </a></th>
				<th class="tdDropTitle" rowspan="3" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">其中:耐热导线(千米)</font> </a></th>
				<th class="tdDropTitle" rowspan="3" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">架空线路投资(万元)</font>
				</a></th>
				<th class="tdDropTitle" rowspan="3" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">电缆长度(千米)</font>
				</a></th>
				<th class="tdDropTitle" rowspan="3" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">沟道长度(千米)</font>
				</a></th>
				<th class="tdDropTitle" rowspan="3" width="60px"><a
					style="cursor: pointer;"> <font color="#1D6597">电缆投资(万元)</font>
				</a>
				</th>
				<th class="tdDropTitle" rowspan="3" width="60px"><a

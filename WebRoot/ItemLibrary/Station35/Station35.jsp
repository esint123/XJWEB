...
<script type="text/javascript">
	function uploadFile(attache_id, attache_field, attache_fileid) {
		var url = "ItemLibrary/AttachFile.jsp?tableName=TItemlibraryStation35&attache_id=" + attache_id
	...
	function InitData() {
	    ...
	    if(stage=='')
	    {
	    	url="Station35Json.action?treeid="+getQueryString("treeid");
	    }
	    else
	    {
	    	url="Station35Json.action?treeid="+getQueryString("treeid")+"&stage="+stage;
	    }
		$.getJSON(url,
						function(data) {
							$("#productTable tr:gt(2)").remove();
							$.each(
											data.itemlibrarystation35List,
											function(i, value) {
												var trs = "";
												trs += "<tr>";
												trs += "<td>" + value.FA
		...
		<table id="productTable" width="3700px" border="0" cellpadding="0"
			...
			<tr>
				...
				<th class="tdDropTitle" colspan="5" width="60px"><a
					style="cursor: pointer;"> <font>变压器</font> </a></th>
				<th class="tdDropTitle" rowspan="3" width="60px"><a
					style="cursor: pointer;"> <font>断路器(台)</font> </a></th>
				<th class="tdDropTitle" rowspan="3" width="60px"><a
			...
			<tr>
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font>变压器改造台数(台)</font>
				</a></th>
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font>改造变压器编号1</font>
				</a></th>
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font>改造变压器编号2</font>
				</a></th>
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font>改造前主变容量(兆伏安)</font>
				</a></th>
				<th class="tdDropTitle" rowspan="2" width="60px"><a
					style="cursor: pointer;"> <font>改造后主变容量(兆伏安)</font>
				</a></th>
				<th class="tdDropTitle" colspan="2" width="60px"><a

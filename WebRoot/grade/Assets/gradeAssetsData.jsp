...
<script type="text/javascript">
	...
	function InitData() {
		...
		$.getJSON("AssetsJson?treeid="+treeid,
						function(data) {
							$("#productTable tr:gt(0)").remove();
							$.each(data.gradeAssetsList,
											function(i, value) {
												var trs = "";
												trs += "<tr>";
	...
	function delInstance(id) {
		...
		{
		    var url='DeleteAssets?id='+id+"&treeid="+getQueryString("treeid");
			location.href =url;
		}
	}
	function down()
	{
		location.href ="downAssetsOpinion?treeid="+getQueryString("treeid");
	}
	function editOpinion(id)
	{
		var url = "EditAssetsOpinion.action?id="+id;
	...
	function edit(id)
	{
		var url = "EditAssets.action?treeid="+getQueryString("treeid")+"&id="+id;
	...
	function add() {
		var url = "AddAssets.action?treeid="+getQueryString("treeid");
		var iLeft = (screen.width - 1200) / 2;
		var iTop = (screen.height - 700) / 2;
		open(
				url,

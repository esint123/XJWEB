...
<script type="text/javascript">
	...
	function InitData() {
		...
		$.getJSON("CapitalJson?treeid="+treeid,
						function(data) {
							$("#productTable tr:gt(0)").remove();
							$.each(data.gradeCapitalList,
											function(i, value) {
												var trs = "";
												trs += "<tr>";
	...
	function delInstance(id) {
		...
		{
		    var url='DeleteCapital?id='+id+"&treeid="+getQueryString("treeid");
			location.href =url;
		}
	}
	function down()
	{
		location.href ="downCapitalOpinion?treeid="+getQueryString("treeid");
	}
	function editOpinion(id)
	{
		var url = "EditCapitalOpinion.action?id="+id;
	...
	function edit(id)
	{
		var url = "EditCapital.action?treeid="+getQueryString("treeid")+"&id="+id;
	...
	function add() {
		var url = "AddCapital.action?treeid="+getQueryString("treeid");
		var iLeft = (screen.width - 1200) / 2;
		var iTop = (screen.height - 700) / 2;
		open(
				url,

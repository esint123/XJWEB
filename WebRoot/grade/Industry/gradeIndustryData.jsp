...
<script type="text/javascript">
	...
	function InitData() {
		...
		$.getJSON("IndustryJson?treeid="+treeid,
						function(data) {
							$("#productTable tr:gt(0)").remove();
							$.each(data.gradeIndustryList,
											function(i, value) {
												var trs = "";
												trs += "<tr>";
	...
	function delInstance(id) {
		...
		{
		    var url='DeleteIndustry?id='+id+"&treeid="+getQueryString("treeid");
			location.href =url;
		}
	}
	function down()
	{
		location.href ="downIndustryOpinion?treeid="+getQueryString("treeid");
	}
	function editOpinion(id)
	{
		var url = "EditIndustryOpinion.action?id="+id;
	...
	function edit(id)
	{
		var url = "EditIndustry.action?treeid="+getQueryString("treeid")+"&id="+id;
	...
	function add() {
		var url = "AddIndustry.action?treeid="+getQueryString("treeid");
		var iLeft = (screen.width - 1200) / 2;
		var iTop = (screen.height - 700) / 2;
		open(
				url,

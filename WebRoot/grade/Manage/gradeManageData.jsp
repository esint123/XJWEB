...
<script type="text/javascript">
	...
	function InitData() {
		...
		$.getJSON("ManageJson?treeid="+treeid,
						function(data) {
							$("#productTable tr:gt(0)").remove();
							$.each(data.gradeManageList,
											function(i, value) {
												var trs = "";
												trs += "<tr>";
	...
	function delInstance(id) {
		...
		{
		    var url='DeleteManage?id='+id+"&treeid="+getQueryString("treeid");
			location.href =url;
		}
	}
	function down()
	{
		location.href ="downManageOpinion?treeid="+getQueryString("treeid");
	}
	function editOpinion(id)
	{
		var url = "EditManageOpinion.action?id="+id;
	...
	function edit(id)
	{
		var url = "EditManage.action?treeid="+getQueryString("treeid")+"&id="+id;
	...
	function add() {
		var url = "AddManage.action?treeid="+getQueryString("treeid");
		var iLeft = (screen.width - 1200) / 2;
		var iTop = (screen.height - 700) / 2;
		open(
				url,

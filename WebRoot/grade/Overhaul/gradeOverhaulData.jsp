...
<script type="text/javascript">
	...
	function InitData() {
		...
		$.getJSON("OverhaulJson?treeid="+treeid,
						function(data) {
							$("#productTable tr:gt(0)").remove();
							$.each(data.gradeOverhaulList,
											function(i, value) {
												var trs = "";
												trs += "<tr>";
	...
	function delInstance(id) {
		...
		{
		    var url='DeleteOverhaul?id='+id+"&treeid="+getQueryString("treeid");
			location.href =url;
		}
	}
	function down()
	{
		location.href ="downOverhaulOpinion?treeid="+getQueryString("treeid");
	}
	function editOpinion(id)
	{
		var url = "EditOverhaulOpinion.action?id="+id;
	...
	function edit(id)
	{
		var url = "EditOverhaul.action?treeid="+getQueryString("treeid")+"&id="+id;
	...
	function add() {
		var url = "AddOverhaul.action?treeid="+getQueryString("treeid");
		var iLeft = (screen.width - 1200) / 2;
		var iTop = (screen.height - 700) / 2;
		open(
				url,

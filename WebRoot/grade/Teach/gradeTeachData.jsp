...
<script type="text/javascript">
	...
	function InitData() {
		...
		$.getJSON("TeachJson?treeid="+treeid,
						function(data) {
							$("#productTable tr:gt(0)").remove();
							$.each(data.gradeTeachList,
											function(i, value) {
												var trs = "";
												trs += "<tr>";
	...
	function delInstance(id) {
		...
		{
		    var url='DeleteTeach?id='+id+"&treeid="+getQueryString("treeid");
			location.href =url;
		}
	}
	function down()
	{
		location.href ="downTeachOpinion?treeid="+getQueryString("treeid");
	}
	function editOpinion(id)
	{
		var url = "EditTeachOpinion.action?id="+id;
	...
	function edit(id)
	{
		var url = "EditTeach.action?treeid="+getQueryString("treeid")+"&id="+id;
	...
	function add() {
		var url = "AddTeach.action?treeid="+getQueryString("treeid");
		var iLeft = (screen.width - 1200) / 2;
		var iTop = (screen.height - 700) / 2;
		open(
				url,

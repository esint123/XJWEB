...
<script type="text/javascript">
	...
	function InitData() {
		...
		$.getJSON("TechnicalJson?treeid="+treeid,
						function(data) {
							$("#productTable tr:gt(0)").remove();
							$.each(data.gradeTechnicalList,
											function(i, value) {
												var trs = "";
												trs += "<tr>";
	...
	function delInstance(id) {
		...
		{
		    var url='DeleteTechnical?id='+id+"&treeid="+getQueryString("treeid");
			location.href =url;
		}
	}
	function down()
	{
		location.href ="downTechnicalOpinion?treeid="+getQueryString("treeid");
	}
	function editOpinion(id)
	{
		var url = "EditTechnicalOpinion.action?id="+id;
	...
	function edit(id)
	{
		var url = "EditTechnical.action?treeid="+getQueryString("treeid")+"&id="+id;
	...
	function add() {
		var url = "AddTechnical.action?treeid="+getQueryString("treeid");
		var iLeft = (screen.width - 1200) / 2;
		var iTop = (screen.height - 700) / 2;
		open(
				url,

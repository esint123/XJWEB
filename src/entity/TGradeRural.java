...
public class TGradeRural implements java.io.Serializable {

	private static final long serialVersionUID = -7264660537638948017L;
	private Integer id;
	...
	/** minimal constructor */
	public TGradeRural(Integer treeid) {
		this.treeid = treeid;
	}

	/** full constructor */
	public TGradeRural(Integer treeid, String reviewname, String reviewunit,
			String reviewtime, String reviewontime, String reviewclass,
			String reviewexpert, Double grade1, Double grade2, Double grade3,
			Double grade4, Double grade5, Double grade6, Double grade7,
			Double grade8, Double grade9, Double grade10, Double grade11,
			Double grade12, Double grade13, Double grade14, Double grade15,
			Double grade16, Double grade17, Double grade18, Double grade19,
			Double grade20, Double grade21, Double grade22, Double grade23,
			Double grade24, Double grade25, Double grade26, Double grade27,
			Double grade28, Double grade29, Double grade30, Double grade31,
			Double grade32, Double grade33, Double grade34, Double grade35,
			Double grade36, String reason1, String reason2, String reason3,
			...
			String reason24, String reason25, String reason26, String reason27,
			String reason28, String reason29, String reason30, String reason31,
			String reason32, String reason33, String reason34, String reason35,
			String reason36, String remark1, String remark2, String remark3,
